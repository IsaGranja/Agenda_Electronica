                    ...
                    <table id="myTable" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{action('AsignaturaXEstudianteController@edit', $estudiante['cedestudiante'])}}"
                                        class="btn btn-primary">Nuevo</a></td>
                                <td><a href="{{action('AsignaturaXEstudianteController@edit', $estudiante['cedestudiante'])}}"
                                        class="btn btn-warning">Modificar</a></td>
                                <td>
                                    <form
                                        action="{{action('AsignaturaXEstudianteController@destroy', $estudiante['cedestudiante'])}}"
                                        method="post">
                                        @csrf
