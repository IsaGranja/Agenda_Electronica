                ...
                <div class = "col-md-8">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <option value="{{$univexcarrera->codcarrera}}">{{$univexcarrera->descuniversidad}}-{{$univexcarrera->descsede}}-{{$univexcarrera->descfacultad}}-{{$univexcarrera->descescuela}}-{{$univexcarrera->desccarrera}}</option>
                                @foreach($test as $t)                      
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control input-lg" name="codasignatura" id="codasignatura">                    
                                <option value="{{$asigxunidad->codasignatura}}">{{$asigxunidad->descasignatura}}</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="numunidad"  value="{{$asigxunidad->numunidad}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="descunidad" value="{{$asigxunidad->descunidad}}">
                        </div>
                    </div>
